                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <div class="logo-area pt-0">
                            <a href="http://thestarkidz.com/index.php"><img src="http://thestarkidz.com/images/logo.jpg" alt="logo"></a>
                        </div>
                    </div>
                                ...
                                <ul class="text-right">
                                    ...
                                    <li>
                                    	<div class="dropdown d-inline-block">
                                    		<a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Contest<i class="fa fa-angle-down"></i></a>
                                    		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="margin: 0px; position: absolute; left: 0px; top: 0px; right: auto; bottom: auto; transform: translate(-133px, 26px);" data-popper-placement="bottom-start">
                                    			<a class="dropdown-item" href="http://thestarkidz.com/coloursmith.php">THE COLOURSMITH</a>
	                                            <a class="dropdown-item" href="http://thestarkidz.com/notesmith.php">THE NOTESMITH</a>
	                                            <a class="dropdown-item" href="http://thestarkidz.com/wordsmith.php">THE WORDSMITH</a>
	                                            <a class="dropdown-item" href="http://thestarkidz.com/craftsmith.php">THE CRAFTSMITH</a>
                                    		</div>
                                    	</div>
                                    </li> 
                                    <li><a href="http://thestarkidz.com/gallery.php">Gallery</i></a></li> 
                                    <li><a href="http://thestarkidz.com/sponsorship.php">Sponsorship</i></a></li> 
                                    <li>
                                    	<div class="dropdown d-inline-block">
                                    		<a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Contact Us<i class="fa fa-angle-down"></i></a>
                                    		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="margin: 0px; position: absolute; left: 0px; top: 0px; right: auto; bottom: auto; transform: translate(-133px, 26px);" data-popper-placement="bottom-start">
                                    			<a class="dropdown-item" href="http://thestarkidz.com/feedback.php">Feedback</a>
                                    			<a class="dropdown-item" href="http://thestarkidz.com/join_team.php">Join Our Team</a>
                                    		</div>
                                    	</div>
                                    </li>
                                </ul>
