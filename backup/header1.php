                            ...
                            <div class="right-side-tool text-right">
                               <!--  <div class="social-media-area">
                                ...
                                <div class="header-top-right">
                                    <ul>
                                        <li><a href="fb.me/thestarkidzhome"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="row">
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul class="text-right">
                                        ...
                                        <li><a href="about.php">Sponsorship<!-- <i class="fa fa-angle-down"></i> --></a>
                                            <!-- <ul>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="cart-area sign-in">
                                <a href="http://thestarkidz.com/cp">Register Now <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul>
                                        ...
                                        <li><a href="about.php">Sponsorship</a>
                                            <!-- <ul>
                                                <li><a href="blog.html">Blog</a></li>
                                                <li><a href="blog-left.html">Blog Left Sidebar</a></li>
                                                <li><a href="blog-right.html">Blog Right Sidebar</a></li>
